                    ...
                    {hasSelection ? (
                            ...
                            <div className="flex items-center gap-2">
                                <div className="flex items-center bg-slate-100 p-1 rounded-xl border border-slate-200">
                                    <button
                                        ...
                                        className="px-3 py-1.5 rounded-lg text-xs font-semibold text-slate-600 hover:text-indigo-600 hover:bg-white hover:shadow-sm disabled:opacity-50 transition-all flex items-center cursor-pointer"
                                        title="Proctorship"
                                    >
                        ...
                        <div className="animate-in fade-in zoom-in-95 duration-200 w-full lg:w-auto">
                            <button
                                ...
                                disabled={isGenerating}
                                className="group flex items-center justify-center w-full lg:w-auto px-4 py-2.5 bg-white border border-slate-200 rounded-xl text-sm font-medium text-slate-600 hover:text-emerald-700 hover:border-emerald-200 hover:bg-emerald-50 transition-all duration-200 shadow-sm cursor-pointer" 
                            >
