                    ...
                    {hasSelection ? (
                        <div className="flex items-center gap-2 animate-in fade-in slide-in-from-right-4 duration-300">
                            ...
                            <div className="flex items-center bg-slate-100 p-1 rounded-xl border border-slate-200">
                                ...
                                {/* REMOVED: Export Excel for Selection (As requested) */}
                                
                                <button
                                    onClick={handleBulkGeneratePDF_V1}
                                    disabled={isGenerating}
                                    className="px-3 py-1.5 rounded-lg text-xs font-semibold text-slate-600 hover:text-indigo-600 hover:bg-white hover:shadow-sm disabled:opacity-50 transition-all flex items-center cursor-pointer disabled:cursor-not-allowed"
                            ...
                            <button
                                ...
                                disabled={isGenerating}
                                className="p-2.5 rounded-xl bg-white border border-rose-200 text-rose-600 hover:bg-rose-50 hover:border-rose-300 transition-all shadow-sm disabled:opacity-50 cursor-pointer disabled:cursor-not-allowed"
